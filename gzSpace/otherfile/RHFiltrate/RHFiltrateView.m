...
//        _collectionView.layer.shadowOffset = CGSizeMake(1,1);//shadowOffset阴影偏移,x向右偏移4，y向下偏移4，默认(0, -3),这个跟shadowRadius配合使用
//        _collectionView.layer.shadowOpacity = 0.3;//阴影透明度，默认0
//       _collectionView.layer.shadowRadius = 3;//阴影半径，默认3
